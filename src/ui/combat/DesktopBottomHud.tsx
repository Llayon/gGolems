import { formatSpeedUnit } from '../../i18n/format';
...
export function DesktopBottomHud(props: {
    gameState: GameHudState;
    viewModel: DesktopBottomHudViewModel;
    locale: Locale;
    t: Translator;
}) {
    const { gameState, viewModel, locale, t } = props;
                ...
                <div className="relative h-[188px] w-20 rounded-[26px] border border-[#8f6a38]/70 bg-[linear-gradient(180deg,rgba(13,13,13,0.94),rgba(28,20,15,0.96))] p-3 shadow-[inset_0_0_18px_rgba(0,0,0,0.5)]">
                    ...
                    <div className="relative mx-auto h-[136px] w-7 rounded-full border border-[#6c5330]/70 bg-[#060606]/80">
                        ...
                        <div
                            ...
                            style={{ height: viewModel.forwardFillHeight }}
                        />
                        <div
                            ...
                            style={{ height: viewModel.reverseFillHeight }}
                        />
                    </div>
            ...
            <div className="flex w-[250px] gap-4">
                <div className="flex-1 rounded-[26px] border border-[#8f6a38]/70 bg-[linear-gradient(180deg,rgba(13,13,13,0.94),rgba(28,20,15,0.96))] p-4 shadow-[inset_0_0_18px_rgba(0,0,0,0.5)]">
                    ...
                    <div className="mt-4 h-2 rounded-full bg-[#241c16]">
                        <div className="h-full rounded-full bg-[linear-gradient(90deg,#7ee6f0,#efb768)]" style={{ width: `${viewModel.speedFillPercent}%` }} />
                    </div>
                </div>
                ...
                <div className="flex w-[132px] flex-col gap-3">
                    ...
                    <div className="rounded-[24px] border border-[#8f6a38]/70 bg-[linear-gradient(180deg,rgba(13,13,13,0.94),rgba(28,20,15,0.96))] p-3 shadow-[inset_0_0_18px_rgba(0,0,0,0.5)]">
                        ...
                        <div className="mt-2 h-2 rounded-full bg-[#241c16]">
                            <div className="h-full rounded-full bg-[linear-gradient(90deg,#d04838,#f0b371)]" style={{ width: `${viewModel.hpFillPercent}%` }} />
                        </div>
                        <div className="mt-2 text-xs tracking-[0.16em] text-[#f3deb5]">{viewModel.hpLabel}</div>
                    </div>

                    <div className={`rounded-[24px] border p-3 shadow-[inset_0_0_18px_rgba(0,0,0,0.5)] ${viewModel.steamWarning ? 'border-[#f25c54]/70 bg-[linear-gradient(180deg,rgba(64,18,18,0.94),rgba(28,12,12,0.96))]' : 'border-[#8f6a38]/70 bg-[linear-gradient(180deg,rgba(13,13,13,0.94),rgba(28,20,15,0.96))]'}`}>
                        <div className="text-[9px] tracking-[0.28em] text-[#efb768]">{t('hud.pressure')}</div>
                        <div className="mt-2 h-2 rounded-full bg-[#241c16]">
                            <div className={`h-full rounded-full ${viewModel.steamWarning ? 'bg-[linear-gradient(90deg,#ff8855,#f25c54)]' : 'bg-[linear-gradient(90deg,#efb768,#7ee6f0)]'}`} style={{ width: `${viewModel.steamFillPercent}%` }} />
                        </div>
