...
const en = {
    ...
    'lobby.modeHint.1v1': 'Solo duel vs one bot, first to 5 frags in six minutes.',
    ...
    'hud.point.pressuring': '{{team}} PRESSURING {{point}} {{progress}}',
    'hud.point.holding': '{{team}} HOLDS {{count}}',
    'hud.point.split': 'CONTROL SPLIT {{blue}}-{{red}}',
    'hud.point.neutral': 'ALL POINTS NEUTRAL',
    'hud.point.counts': 'CONTROL {{blue}}-{{red}}',
    'hud.point.lead': '{{team}} LEAD +{{margin}}',
