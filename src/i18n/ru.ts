...
const ru: typeof en = {
    ...
    'weapon.scatterslug': 'ДРОБЬ',
    'weapon.rocketPod': 'РАКЕТНАЯ УСТАНОВКА',
    'weapon.short.runeBolt': 'БОЛТ',
    'weapon.short.arcEmitter': 'ДУГА',
    'weapon.short.steamCannon': 'ПУШКА',
    'weapon.short.scatterslug': 'ДРОБЬ',
    'weapon.short.rocketPod': 'РАКЕТА',
